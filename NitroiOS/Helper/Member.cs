...
namespace location2
{
	...
	public class RootMemberModel : RootObject
	{
		...
		public string krun { get { return rootMember.profile.bestResults[0].value; } set { rootMember.profile.bestResults[0].value = value; } }
		public string hmarathon { get { return rootMember.profile.bestResults[1].value; } set { rootMember.profile.bestResults[1].value = value; } }
		public string fmarathon { get { return rootMember.profile.bestResults[2].value; } set { rootMember.profile.bestResults[2].value = value; } }
		...
		//experience run
		public string rZone1HR { get { return rootMember.profile.fields[1].ZoneLevel[0].hr; } set { rootMember.profile.fields[1].ZoneLevel[0].hr = value; } }
		public string rZone2HR { get { return rootMember.profile.fields[1].ZoneLevel[1].hr; } set { rootMember.profile.fields[1].ZoneLevel[1].hr = value; } }
		public string rZone3HR { get { return rootMember.profile.fields[1].ZoneLevel[2].hr; } set { rootMember.profile.fields[1].ZoneLevel[2].hr = value; } }
		public string rZone4HR { get { return rootMember.profile.fields[1].ZoneLevel[3].hr; } set { rootMember.profile.fields[1].ZoneLevel[3].hr = value; } }
		public string rZone5HR { get { return rootMember.profile.fields[1].ZoneLevel[4].hr; } set { rootMember.profile.fields[1].ZoneLevel[4].hr = value; } }

		public string rZone1PACE { get { return rootMember.profile.fields[1].ZoneLevel[0].pace; } set { rootMember.profile.fields[1].ZoneLevel[0].pace = value; } }
		public string rZone2PACE { get { return rootMember.profile.fields[1].ZoneLevel[1].pace; } set { rootMember.profile.fields[1].ZoneLevel[1].pace = value; } }
		public string rZone3PACE { get { return rootMember.profile.fields[1].ZoneLevel[2].pace; } set { rootMember.profile.fields[1].ZoneLevel[2].pace = value; } }
		public string rZone4PACE { get { return rootMember.profile.fields[1].ZoneLevel[3].pace; } set { rootMember.profile.fields[1].ZoneLevel[3].pace = value; } }
		public string rZone5PACE { get { return rootMember.profile.fields[1].ZoneLevel[4].pace; } set { rootMember.profile.fields[1].ZoneLevel[4].pace = value; } }

		public string rZone1POWER { get { return rootMember.profile.fields[1].ZoneLevel[0].power; } set { rootMember.profile.fields[1].ZoneLevel[0].power = value; } }
		public string rZone2POWER { get { return rootMember.profile.fields[1].ZoneLevel[1].power; } set { rootMember.profile.fields[1].ZoneLevel[1].power = value; } }
		public string rZone3POWER { get { return rootMember.profile.fields[1].ZoneLevel[2].power; } set { rootMember.profile.fields[1].ZoneLevel[2].power = value; } }
		public string rZone4POWER { get { return rootMember.profile.fields[1].ZoneLevel[3].power; } set { rootMember.profile.fields[1].ZoneLevel[3].power = value; } }
		public string rZone5POWER { get { return rootMember.profile.fields[1].ZoneLevel[4].power; } set { rootMember.profile.fields[1].ZoneLevel[4].power = value; } }

		public string rFTPace { get { return rootMember.profile.fields[1].FTPACE; } set { rootMember.profile.fields[1].FTPACE = value; } }
		public string rFTPHB { get { return rootMember.profile.fields[1].FTPHB; } set { rootMember.profile.fields[1].FTPHB = value; } }
		public string rFTPower { get { return rootMember.profile.fields[1].FTPWATT; } set { rootMember.profile.fields[1].FTPWATT = value; } }

		//experience bike
		public string bZone1HR { get { return rootMember.profile.fields[2].ZoneLevel[0].hr; } set { rootMember.profile.fields[2].ZoneLevel[0].hr = value; } }
		public string bZone2HR { get { return rootMember.profile.fields[2].ZoneLevel[1].hr; } set { rootMember.profile.fields[2].ZoneLevel[1].hr = value; } }
		public string bZone3HR { get { return rootMember.profile.fields[2].ZoneLevel[2].hr; } set { rootMember.profile.fields[2].ZoneLevel[2].hr = value; } }
		public string bZone4HR { get { return rootMember.profile.fields[2].ZoneLevel[3].hr; } set { rootMember.profile.fields[2].ZoneLevel[3].hr = value; } }
		public string bZone5HR { get { return rootMember.profile.fields[2].ZoneLevel[4].hr; } set { rootMember.profile.fields[2].ZoneLevel[4].hr = value; } }

		public string bZone1POWER { get { return rootMember.profile.fields[2].ZoneLevel[0].power; } set { rootMember.profile.fields[2].ZoneLevel[0].power = value; } }
		public string bZone2POWER { get { return rootMember.profile.fields[2].ZoneLevel[1].power; } set { rootMember.profile.fields[2].ZoneLevel[1].power = value; } }
		public string bZone3POWER { get { return rootMember.profile.fields[2].ZoneLevel[2].power; } set { rootMember.profile.fields[2].ZoneLevel[2].power = value; } }
		public string bZone4POWER { get { return rootMember.profile.fields[2].ZoneLevel[3].power; } set { rootMember.profile.fields[2].ZoneLevel[3].power = value; } }
		public string bZone5POWER { get { return rootMember.profile.fields[2].ZoneLevel[4].power; } set { rootMember.profile.fields[2].ZoneLevel[4].power = value; } }

		public string bFTPace { get { return rootMember.profile.fields[2].FTPACE; } set { rootMember.profile.fields[2].FTPACE = value; } }
		public string bFTPHB { get { return rootMember.profile.fields[2].FTPHB; } set { rootMember.profile.fields[2].FTPHB = value; } }
