...
void xamarin_create_classes () {
	...
	__xamarin_class_map [16].handle = objc_getClass ("CLBeacon");
	...
	__xamarin_class_map [40].handle = objc_getClass ("NSUserDefaults");
	__xamarin_class_map [41].handle = objc_getClass ("NSUUID");
