...
void xamarin_create_classes () {
	...
	__xamarin_class_map [17].handle = objc_getClass ("CLBeacon");
	__xamarin_class_map [18].handle = objc_getClass ("CLRegion");
	__xamarin_class_map [19].handle = objc_getClass ("CLBeaconRegion");
	...
	__xamarin_class_map [31].handle = objc_getClass ("NSPredicate");
	...
	__xamarin_class_map [41].handle = objc_getClass ("NSUserDefaults");
	__xamarin_class_map [42].handle = objc_getClass ("NSUUID");
	...
	__xamarin_class_map [45].handle = objc_getClass ("EKObject");
	__xamarin_class_map [46].handle = objc_getClass ("EKAlarm");
	__xamarin_class_map [47].handle = objc_getClass ("EKCalendar");
	__xamarin_class_map [48].handle = objc_getClass ("EKCalendarItem");
	__xamarin_class_map [49].handle = objc_getClass ("EKEvent");
	__xamarin_class_map [50].handle = objc_getClass ("EKEventStore");
	...
	__xamarin_class_map [56].handle = objc_getClass ("UISpringTimingParameters");
	__xamarin_class_map [57].handle = objc_getClass ("UIApplication");
	__xamarin_class_map [58].handle = objc_getClass ("UIDevice");
	__xamarin_class_map [59].handle = objc_getClass ("UIBezierPath");
	__xamarin_class_map [60].handle = objc_getClass ("UIButton");
	...
	__xamarin_class_map [73].handle = objc_getClass ("NSStringDrawingContext");
	...
	__xamarin_class_map [80].handle = objc_getClass ("UIImagePickerController");
	__xamarin_class_map [81].handle = objc_getClass ("NSData");
	__xamarin_class_map [82].handle = objc_getClass ("NSDictionary");
	__xamarin_class_map [83].handle = objc_getClass ("CLLocationManager");
	__xamarin_class_map [84].handle = objc_getClass ("NSMutableDictionary");
	__xamarin_class_map [85].handle = objc_getClass ("NSNotificationCenter");
