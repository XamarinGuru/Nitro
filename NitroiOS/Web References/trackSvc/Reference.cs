...
namespace location2.trackSvc {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback calcStressOperationCompleted;
        ...
        /// CodeRemarks
        public event calcStressCompletedEventHandler calcStressCompleted;
        ...
        /// CodeRemarks
        public void updateMomgoCalendarAsync(string eventName, string startTime, string endTime, string userId, string eventData, string eventTotal, string type, string programName, string programStart, string programEnd, string tss, string hb) {
            this.updateMomgoCalendarAsync(eventName, startTime, endTime, userId, eventData, eventTotal, type, programName, programStart, programEnd, tss, hb, null);
        }
        
        /// CodeRemarks
        public void updateMomgoCalendarAsync(string eventName, string startTime, string endTime, string userId, string eventData, string eventTotal, string type, string programName, string programStart, string programEnd, string tss, string hb, object userState) {
            ...
            this.InvokeAsync("updateMomgoCalendar", new object[] {
                        ...
                        programEnd,
                        tss,
                        hb}, this.updateMomgoCalendarOperationCompleted, userState);
        }
        ...
        /// CodeRemarks
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IService1/calcStress", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlArrayAttribute(IsNullable=true)]
        ...
        public BsonElement[] calcStress(System.DateTime date, [System.Xml.Serialization.XmlIgnoreAttribute()] bool dateSpecified, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string userId, float lastTss, [System.Xml.Serialization.XmlIgnoreAttribute()] bool lastTssSpecified) {
            object[] results = this.Invoke("calcStress", new object[] {
                        date,
                        dateSpecified,
                        userId,
                        lastTss,
        ...
        /// CodeRemarks
        public void calcStressAsync(System.DateTime date, bool dateSpecified, string userId, float lastTss, bool lastTssSpecified) {
            this.calcStressAsync(date, dateSpecified, userId, lastTss, lastTssSpecified, null);
        }
        
        /// CodeRemarks
        public void calcStressAsync(System.DateTime date, bool dateSpecified, string userId, float lastTss, bool lastTssSpecified, object userState) {
            if ((this.calcStressOperationCompleted == null)) {
                this.calcStressOperationCompleted = new System.Threading.SendOrPostCallback(this.OncalcStressOperationCompleted);
            }
            this.InvokeAsync("calcStress", new object[] {
                        date,
                        dateSpecified,
                        userId,
                        lastTss,
                        lastTssSpecified}, this.calcStressOperationCompleted, userState);
        }
        
        private void OncalcStressOperationCompleted(object arg) {
            if ((this.calcStressCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.calcStressCompleted(this, new calcStressCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// CodeRemarks
        public void updateCoachNotesAsync(string notes, string id, string group, string genData, string totalDist, string tss, string hb, string usernn) {
            this.updateCoachNotesAsync(notes, id, group, genData, totalDist, tss, hb, usernn, null);
        }
        
        /// CodeRemarks
        public void updateCoachNotesAsync(string notes, string id, string group, string genData, string totalDist, string tss, string hb, string usernn, object userState) {
            ...
            this.InvokeAsync("updateCoachNotes", new object[] {
                        ...
                        tss,
                        hb,
                        usernn}, this.updateCoachNotesOperationCompleted, userState);
        }
	...
	insertNewDeviceCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
    ...
    /// CodeRemarks
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XamarinStudio", "4.0.0.0")]
    public delegate void calcStressCompletedEventHandler(object sender, calcStressCompletedEventArgs e);
    
    /// CodeRemarks
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XamarinStudio", "4.0.0.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class calcStressCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal calcStressCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
